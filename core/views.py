...
@update_user_ip
def about(request):
    return render(request, "pages/about.html", {"type": "About Bitwatt Network Inc.", "crumbs": ["About Us"]})

@update_user_ip
def contact(request):
    return render(request, "pages/contact.html", {"type": "Contact Support Team At Bitwatt Network Inc.", "crumbs": ["Contact Us"]})

@update_user_ip
def send_contact_email(request):
    res = render(request, "pages/message_page.html",
                 {"title": "Oops", "msg": "Sorry, something is wrong with the server but you can mail us at <a href='mailto:frontdesk.bitwatt@gmail.com'>frontdesk.bitwatt@gmail.com</a>"})
